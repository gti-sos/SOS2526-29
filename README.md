...
Esta seccion esta pensada para una defensa real: si el profesor pide un cambio, no vale decir "eso esta en el backend". Hay que saber el archivo exacto, la funcion aproximada y la comprobacion. La version larga esta en [docs/GUIA_DEFENSA.md](docs/GUIA_DEFENSA.md).
